                            ...
                            <form action="{{route('myExpense.edit', $myExpense->id)}}" method="POST">
                              ...
                              <div class="card-body">
                                ...
                                <div class="form-group">
                                  ...
                                  <input name='amount' required value="{{$myExpense->amount}}" type="number" min=0 step=".01" class="form-control" id="editAmount"
