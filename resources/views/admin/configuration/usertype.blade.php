                        ...
                        <form action="{{route('usertype.add')}}" method="POST">
                          ...
                          <div class="card-body">
                            ...
                            <div class="form-group">
                              ...
                              <input name="duration" required type="number" class="form-control" id="duration"
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <div class="btn-group bg-success">
                          ...
                          <a href="{{route('usertype.delete', $usertype->id)}}" id="delete" type="button"
                            ...
                            <form action="{{route('usertype.edit', $usertype->id)}}" method="POST">
                              ...
                              <div class="card-body">
                                <div class="form-group">
                                  ...
                                  <input type="number" name="duration" value="{{$usertype->duration}}"
                                    class="form-control" id="editDuration" placeholder="Duration in month">
                                  @error('duration')
                                  <span class="text-danger text-sm">{{$message}}</span>
                                  @enderror
                                </div>
                              ...
                              <div class="form-check">
                                <input name="isActive" type="checkbox" class="form-check-input" id="editIsActive"
                                  {{($usertype->isactive == '1'?"checked":"")}}>
